...
insults=[]
max_nodes = 3  # Nombre màxim de nodes
current_nodes = 1  # Nombre inicial de nodes
...
# Funció per crear un node dinàmicament
def add_dynamic_node():
    global current_nodes
    if current_nodes < max_nodes:
        port.append(port[-1] + 1)  # Assigna un nou port
        current_nodes += 1
        print(f"Afegint node nou a {port[-1]}")
